...
namespace GrampsView.Data.DataView
{
    ...
    public interface IMediaDataView : IDataViewBase<MediaModel, HLinkMediaModel, HLinkMediaModelCollection>
    {
        ...
        /// <returns>
        /// </returns>
        HLinkMediaModel GetFirstIconFromCollection(HLinkMediaModelCollection theCollection);
        ...
        /// <returns>
        /// </returns>
        HLinkMediaModel GetRandomFromCollection(HLinkMediaModelCollection theCollection);

        //MediaModel LoadImage(HLinkMediaModel argHLink);
    }
}