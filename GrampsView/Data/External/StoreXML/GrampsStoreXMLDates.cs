...
namespace GrampsView.Data.ExternalStorageNS
{
    ...
    // <choice> <element name = "daterange" > < attribute name="start"><text/></attribute> <attribute
    // name = "stop" >< text /></ attribute > < optional >< attribute name="quality"><choice>
    // <value>estimated</value> <value>calculated</value> </choice></attribute></optional>
    // <optional><attribute name = "cformat" >< text /></ attribute ></ optional > < optional ><
    // attribute name="dualdated"> <choice><value>0</value><value>1</value></choice>
    // </attribute></optional> <optional><attribute name = "newyear" >< text /></ attribute ></
    // optional > </ element > < element name="datespan"> <attribute name = "start" >< text /></
    // attribute > < attribute name="stop"><text/></attribute> <optional><attribute name = "quality"
    // >< choice > < value > estimated </ value > < value > calculated </ value > </ choice ></
    // attribute ></ optional > < optional >< attribute name="cformat"><text/></attribute></optional>
    ...
    // <optional><attribute name = "cformat" >< text /></ attribute ></ optional > < optional ><
    // attribute name="type"><choice> <value>before</value> <value>after</value> <value>about</value>
    // </choice></attribute></optional> <optional><attribute name = "quality" >< choice > < value >
    // estimated </ value > < value > calculated </ value > </ choice ></ attribute ></ optional > <
    // optional >< attribute name="dualdated"> <choice><value>0</value><value>1</value></choice>
    // </attribute></optional> <optional><attribute name = "newyear" >< text /></ attribute ></
    // optional > </ element > < element name="datestr"> <attribute name = "val" >< text /></
    // attribute > </ element > </ choice > </ define > </ code >
    public partial class GrampsStoreXML : CommonBindableBase, IGrampsStoreXML
    {
        ...
        public DateObjectModel SetDateVal(XElement currentElement)
        {
            ...
            return new DateObjectModel(DateObjectModel.DateType.Val, aCFormat, aDualDated, aNewYear, aQuality, aStart, aStop, aVal, aValType);
        }
        ...
        private DateObjectModel SetDateRange(XElement currentElement)
        {
            ...
            return new DateObjectModel(DateObjectModel.DateType.Range, aCFormat, aDualDated, aNewYear, aQuality, aStart, aStop, aVal, aValType);
        }
    }
}