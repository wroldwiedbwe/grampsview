        ...
        public async Task<bool> FixMediaFiles()
        {
            ...
            if (localMediaFolder != null)
            {
                ...
                { // if (item.Id == "O0259") { }
                    ...
                    //        DataStore.DS.MediaData[item.HLinkKey].MediaStorageFile = await StoreFolder.FolderGetFileAsync(localMediaFolder, item.OriginalFilePath).ConfigureAwait(false);
                    //    }
                    //}
