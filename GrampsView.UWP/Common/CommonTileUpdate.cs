...
namespace GrampsView.UWP.Common
{
    ...
    public static class CommonTileUpdate
    {
        ...
        /// <returns>
        /// </returns>
        private static TileBinding GenerateTileBindingLarge(MediaModel media)
        {
        ...
        /// <returns>
        /// </returns>
        private static TileBinding GenerateTileBindingMedium(MediaModel media)
        {
            return new TileBinding()
            {
                Branding = TileBranding.NameAndLogo,
        ...
        /// <returns>
        /// </returns>
        private static TileBinding GenerateTileBindingWide(MediaModel media)
        {
            return new TileBinding()
            {
                Branding = TileBranding.NameAndLogo,
        ...
        /// <returns>
        /// </returns>
        private static TileContent GenerateTileContent(MediaModel media)
        {
            if (media != null)
            {
